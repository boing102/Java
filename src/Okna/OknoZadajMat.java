...
/**
 * Sluzi na zadanie testu z matematiky urcitej triede.
 * @author Martin Mekota
 *
 */
public class OknoZadajMat extends JFrame {

	private JPanel panel;
	private JTextField trieda;
	public Ucitel ucitel;
	
	public OknoZadajMat(Ucitel u) {
		setTitle("Zadanie Matematiky");
		try {
