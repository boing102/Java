...
/**
 * Okno, v ktorom ziak zadava odpovede z matematiky.
 * @author Martin Mekota	
 */
public class OknoMatika extends JFrame {
	...
	public OknoMatika(Ziak z) {
		...
		String o1 = "Otazka 1: " + ziak.getDomacaUloha()[0].getOtakza1();
		...
		String o2 = "Otazka 2: " + ziak.getDomacaUloha()[0].getOtazka2();
		...
		String o3 = "Otazka 3: " + ziak.getDomacaUloha()[0].getOtazka3();
		...
		if(ziak.getDomacaUloha()[0].getPomocOtazke1() == null)
			p1 = p1 + "\n ziadna rada.";
		else
			p1 = p1 + "\n" + ziak.getDomacaUloha()[0].getPomocOtazke1();
		pomoc1.setText(p1);
		...
		p1 = pomoc2.getText();
		if(ziak.getDomacaUloha()[0].getPomocOtazke2() == null)
			p1 = p1 + "\n ziadna rada.";
		else
			p1 = p1 + "\n" + ziak.getDomacaUloha()[0].getPomocOtazke2();
		pomoc2.setText(p1);
		...
		p1 = pomoc3.getText();
		if(ziak.getDomacaUloha()[0].getPomocOtazke3() == null)
			p1 = p1 + "\n ziadna rada.";
		else
			p1 = p1 + "\n" + ziak.getDomacaUloha()[0].getPomocOtazke3();
		pomoc3.setText(p1);
	...
	private void ulozit() {
		try{
			DuZMatematiky temp = (DuZMatematiky) ziak.getDomacaUloha()[0];
			temp.setOdpoved1(Integer.parseInt(otazka1.getText()));
			temp.setOdpoved2(Integer.parseInt(otazka2.getText()));
			temp.setOdpoved3(Integer.parseInt(otazka3.getText()));
			dispose();
			new OknoZiak(ziak);
